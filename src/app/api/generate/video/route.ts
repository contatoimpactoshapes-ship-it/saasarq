...
export async function POST(req: NextRequest) {
  try {
    ...
    emitAdminEvent({ type: "generation:started", id: crypto.randomUUID(), ts: Date.now(), generationId: generation.id, userId: user.id, tool: "VIDEO_GENERATE", model: videoModel, creditsCost: CREDIT_COST });
